...
const imageUrls = {
  hiro: [
    'https://cdn.glitch.global/65ebd92e-0f4c-42b3-a401-58e7acf16854/conv1-bg.jpg?v=1731594649706',
    'https://cdn.glitch.global/65ebd92e-0f4c-42b3-a401-58e7acf16854/conv2-bg.jpg?v=1731594651945',
    'https://cdn.glitch.global/65ebd92e-0f4c-42b3-a401-58e7acf16854/conv3-bg.jpg?v=1731594654376'
  ],
...
async function init() {
  ...
  try {
    // Load all images for the Hiro marker
    const hiroImages = [];
    for (const url of imageUrls.hiro) {
      ...
      hiroImages.push({ image: imgBitmap, widthInMeters: 0.2 });
    }
